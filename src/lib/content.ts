...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    lens: {
      ee: "Low-level interactive builds — an ARM assembly simulator in C",
      ai: "Interactive apps in Java & C — Wordle, an AI Pong clone, a generative-Shakespeare GPT",
      research: "40+ Python simulations visualizing physical phenomena",
      all: "40+ simulations and interactive builds — physics, rendered in code",
    },
    order: { ee: 5, ai: 5, research: 4, all: 6 },
    summary:
      "A long-running body of 40+ computational science projects — Python simulations that model and visualize physical phenomena, alongside interactive applications in Java and C: Wordle, an AI Pong clone, an ARM assembly simulator, Sudoku, and a generative Shakespeare GPT.",
    highlights: [
      "40+ simulations of physical phenomena in Python",
      "Interactive builds in Java & C — Wordle, an AI Pong clone, Sudoku",
      "An ARM assembly simulator and a generative Shakespeare GPT",
    ],
    cta: { label: "Open the Lab — run the code live", href: "/lab" },
  },
  {
    slug: "physiome-blog",
    ...
    period: "2023",
    lens: {
      ai: "Designed & deployed the site end to end in HTML, CSS & JavaScript",
      research: "Translating peer-reviewed biophysics into accessible articles",
      all: "A biophysics blog — peer-reviewed research, made readable",
    },
    order: { ai: 6, research: 5, all: 7 },
    summary:
      "A biophysics blog I started to translate peer-reviewed research into accessible articles — researching and writing the pieces, then designing and deploying the website end to end in HTML, CSS, and JavaScript.",
    highlights: [
      "Translated peer-reviewed biophysics into accessible writing",
      "Designed and deployed the site in HTML, CSS & JavaScript",
    ],
  },
  {
    slug: "alunite",
...
export const EXPERIENCE: Role[] = [
  {
    ...
    note: "Engineering peptide nanowires for sustainable oil–water separation; SEM-verified growth and a Python pipeline over 500+ datapoints. Poster at the Colgate Physics & Astronomy Seminar.",
    lenses: ["research"],
  },
  {
    role: "Physics Tutor",
    org: "Department of Physics & Astronomy, Colgate",
    period: "Jan — Apr 2026",
    note: "Guided PHYS 112 students through electricity & magnetism in weekly sessions and quiz/midterm prep.",
    lenses: ["ee"],
  },
  {
    ...
    note: "Resolved software, network, and hardware issues for faculty, staff, and students; documented recurring problems.",
    lenses: [],
  },
  {
    ...
    org: "Information Technology Services, Colgate",
    period: "Sep — Dec 2025",
    note: "Evaluated course sites for accessibility and usability through walkthroughs and peer interviews.",
    lenses: [],
  },
  {
    ...
    note: "Live-in community leader for 30+ residents — programming, mediation, and academic and personal support.",
    lenses: [],
  },
  {
    ...
    period: "Jun — Jul 2025",
    note: "Built the automated hydroponic vanilla system; raised $700 at the Showcase and secured a $10k TIA Accelerator grant.",
    lenses: ["ee"],
  },
  {
    ...
    period: "Jan — Dec 2025",
    note: "Individual feedback on code and algorithm design for 30+ students weekly across COSC 101, 102, 202, 208.",
    lenses: ["ai"],
  },
  {
    ...
    note: "Digitized manuscripts, photographs, and rare books; performed book conservation and archival casing.",
    lenses: [],
  },
  {
    ...
    period: "Sep — Dec 2024",
    note: "Provided structured, accessible WRIT 103 notes for students with accommodations.",
    lenses: [],
  },
  {
    ...
    period: "May — Jul 2023",
    note: "Built a web extension to verify SME minority-ownership status; recognized among 100+ participants.",
    lenses: ["ai"],
  },
];
...
export const INVOLVEMENT: Role[] = [
  {
    ...
    note: "Organize colloquia, workshops, and outreach — raising active participation by 30–40%.",
    lenses: ["research"],
  },
  {
    role: "Treasurer",
    org: "Colgate Coders",
    period: "Jan 2025 — Present",
    note: "Manage budgets and resource allocation for external annual hackathons.",
    lenses: ["ai"],
  },
  {
    role: "President",
    ...
    period: "Jan — Dec 2025",
    note: "Ran operations and biweekly technical workshops; drove cross-disciplinary STEM collaboration.",
    lenses: ["ee"],
  },
  {
    ...
    period: "Apr — Dec 2023",
    note: "Weekly CS and digital-literacy lessons for 100+ students (Grades 3–6); helped women artisans with digital inventory.",
    lenses: ["ai"],
  },
  {
    ...
    note: "Designed campaign materials and social content; coordinated community-welfare workshops.",
    lenses: [],
  },
];
